...
reference_timestamp = long(df_original[0].split()[0].split('.')[0])
df.write(struct.pack('Q', reference_timestamp))
...
for line in df_original:
    ...
    if (to_write):
        lines += 1
        #print line
        df.write(struct.pack('HIccHHHHHH', c_sec-reference_timestamp, c_usec, c_type, c_buysell, c_bid_size, c_bid_price, c_ask_price, c_ask_size, 
